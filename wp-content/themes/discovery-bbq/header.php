...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$discovery_bbq_description = get_bloginfo( 'description', 'display' );
			if ( $discovery_bbq_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $discovery_bbq_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
